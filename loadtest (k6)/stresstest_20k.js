  ...
  scenarios: {
    contacts: {
      ...
      stages: [
        ...
        { duration: '3m', target: 10000 }, // ramp up 10.000 req/min voor 5 min
        { duration: '3m', target: 20000 }, // ramp up naar 20.000 req/min voor 3 min
        { duration: '5m', target: 20000 }, // Houd 20.000 req/min voor 5 min
        { duration: '2m', target: 0 },     // Bouw in 2 min af naar 0
      ],

      preAllocatedVUs: 1500, // Vooraf gereserveerde virtuele users
      maxVUs: 15000,         // Maximaal aantal virtuele users
    },
  },
};
