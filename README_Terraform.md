...
## Terraform setup
1. Navigate to the project folder:`cd /booomtag_cloud_1-main/AwsMultiContainer`
...
## Load testing
**For K6 loadtests, go to:**  
`booomtag_cloud_1-main/AwsMultiContainer/loadtest (k6)`
...
IPv4 and IPv6 are IP's (Internet protocols) and gives every device a unique adress so it can connect to the internet.
The IPv6 can conneect to almost endless adresses while IPv4 has a limited number it can connect to.
